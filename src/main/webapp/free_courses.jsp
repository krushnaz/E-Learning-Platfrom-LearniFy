...
<html>
<head>
<title>Advanced java course</title>
<!-- Bootstrap CSS -->
<link
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					...
					<br>
					<p>Advanced Java refers to the advanced features and
						...
						security, and reliability of their applications. Advanced Java is
						an essential skill for Java developers who want to build
						cutting-edge applications and stay ahead in their careers.</p>
					<div>
						<a href="watchFreeTutorial.jsp"
							class="btn btn-warning text-dark btn-lg font-weight-bold">Enroll
							Now</a>
					</div>
				</div>
				<div class="col-md-6 d-none d-md-block">
					<p class="text-center">Offered by</p>
					<img src="img/java.png" alt="Banner Image"
						...
						<div class="tab-content profile-tab" id="myTabContent">
							<div class="tab-pane fade show active" id="home" role="tabpanel"
								...
								<div class="row">
									...
									<br> This course focuses on the use of technology to
									manage and analyze information in organizations.
									Specializations in this field include data management, network
							...
							<div class="tab-pane fade" id="profile" role="tabpanel"
								...
								<div class="row">
									<h5>This course focuses on the use of technology to manage
										and analyze information in organizations. Specializations in
										this field include data management, network administration,
										web development, and cybersecurity.</h5>
								</div>
	...
	<div class="container bg-light">
		...
		<div class="row">
			<div class="col-md-6">
				...
				<br> <a href="watchFreeTutorial.jsp"
